...
/**
 * An object made of various lines, that can be items or holograms. Holographic lines appear as a
 * nametag without any entity below. To create one, please see {@link
 * HologramsAPI#createHologram(org.bukkit.plugin.Plugin, Location)}.
 */
public interface Hologram {
     ...
     *
     * @param index the line is inserted before this index. If 0, the new line will be inserted
     ...
     * @return the hologram line at the given index, can be an {@link ItemLine} or a {@link
     *     TextLine}.
     * @throws IndexOutOfBoundsException if the index is out of range (index < 0 || index >= size())
     */
     ...
     * Teleports a hologram to the given location.
     *
     * @param world the world where the hologram should be teleported, use {@link #getWorld()} to
     *     teleport it in the same world.
    ...
    /**
     * Returns the {@link VisibilityManager} of this hologram. <br>
     * <b style = "color: red">Note</b>: the usage of the VisibilityManager requires ProtocolLib.
    ...
    /**
     * Sets if the hologram should track and replace placeholders. By default if will not track
     * them.
     *
    ...
    /**
     * Deletes this hologram. Editing or teleporting the hologram when deleted will throw an
     * exception. Lines will be automatically cleared. You should remove all the references of the
     * hologram after deletion.
     */
    void delete();
